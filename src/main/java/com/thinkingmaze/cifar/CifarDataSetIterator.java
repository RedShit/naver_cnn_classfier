...
public class CifarDataSetIterator implements DataSetIterator{
     ...
     */
    public CifarDataSetIterator(RecordReader recordReader, int batchSize) {
     ...
     */
    public CifarDataSetIterator(RecordReader recordReader, int batchSize, int labelIndex, int numPossibleLabels) {
     ...
     * @param recordReader
     */
    public CifarDataSetIterator(RecordReader recordReader) {
     ...
     *
     */
    public CifarDataSetIterator(RecordReader recordReader, int labelIndex, int numPossibleLabels) {
     ...
     * @param regression
     */
    public CifarDataSetIterator(RecordReader recordReader, WritableConverter converter, int batchSize, int labelIndex, int numPossibleLabels,boolean regression) {
    ...
    public CifarDataSetIterator(RecordReader recordReader, WritableConverter converter, int batchSize, int labelIndex, int numPossibleLabels) {
        this(recordReader,converter,batchSize,labelIndex,numPossibleLabels,false);
    }

    public CifarDataSetIterator(RecordReader recordReader, WritableConverter converter) {
        this(recordReader, converter, 10, -1, -1);
    }


    public CifarDataSetIterator(RecordReader recordReader, WritableConverter converter, int labelIndex, int numPossibleLabels) {
