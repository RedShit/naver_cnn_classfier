...
public class CifarRecordReader extends BaseImageRecordReader{
	
	public CifarRecordReader() {
        super();
    }

    public CifarRecordReader(int width, int height, int channels, List<String> labels) {
        super(width, height, channels, labels);
    }

    public CifarRecordReader(int width, int height, int channels, boolean appendLabel, List<String> labels) {
        super(width, height, channels, appendLabel, labels);
    }

    public CifarRecordReader(int width, int height, int channels) {
        super(width, height, channels, false);
    }

    public CifarRecordReader(int width, int height, int channels, boolean appendLabel) {
        super(width, height, channels, appendLabel);
    }

    public CifarRecordReader(int width, int height, List<String> labels) {
        super(width, height, 1, labels);
    }

    public CifarRecordReader(int width, int height, boolean appendLabel, List<String> labels) {
        super(width, height, 1, appendLabel, labels);
    }

    public CifarRecordReader(int width, int height) {
        super(width, height, 1, false);
    }

    public CifarRecordReader(int width, int height, boolean appendLabel) {
        super(width, height, 1, appendLabel);
    }


    public CifarRecordReader(int width, int height, int channels, boolean appendLabel, String pattern) {
